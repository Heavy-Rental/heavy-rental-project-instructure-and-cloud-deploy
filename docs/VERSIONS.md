...
| REST image | study §4.3 | Environment `REST_IMAGE` or Run `image_ref`. Fail if empty. |
...
| Portal | study §6.4a | Environment `PORTAL_IMAGE` (nginx-based CI tag) or stock `nginx` |
