...
| **ADR** | [`../docs/adr/`](../docs/adr/) | Why Vocareum-only, form keys, remote state |
| **Operator** | [`../BOOTSTRAP.md`](../BOOTSTRAP.md) | Environment `academy`, every Start Lab |
| **Program plan** | [`../IMPLEMENTATION-PLAN.md`](../IMPLEMENTATION-PLAN.md) | Three-branch delivery |

Current change: [`../openspec/changes/add-infra-academy-bootstrap/`](../openspec/changes/add-infra-academy-bootstrap/).
